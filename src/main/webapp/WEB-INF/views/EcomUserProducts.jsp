				...
				<div class="col-md-6 col-lg-4 col-xl-3">
					<div id="product-1" class="single-product">
						<div class="part-1">
							...
							<img src=<%=p.getProductImagePath()%> height="100%" width="100%" /></a>
							
								<%System.out.println(p.getProductImagePath());%>
								
							<ul>
								<li><a href="addtocart?productId=<%=p.getProductId()%>">
